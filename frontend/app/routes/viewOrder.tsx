        ...
        <div className="bg-gray-200 flex flex-col" style={{ height: "calc(100vh - 52px)" }}>
            <div className="p-6 flex-1 flex flex-col overflow-hidden">
                <div className="space-y-6 flex-1 flex flex-col">
                    ...
                    {!loading && order && (
                        <>
                            <div className="bg-gray-300 rounded-md p-6 flex-1 flex gap-6">
                            ...
                            <div className="flex gap-4">
                                <button
                                    onClick={handlePay}
                                    className="flex-1 bg-gray-300 hover:bg-green-400 rounded-md py-3 text-black font-medium"
                                >
                                    Pay
                                </button>
                                <button
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-gray-300 hover:bg-red-400 rounded-md py-3 text-black font-medium"
                                >
                                    Delete
                                </button>
                            </div>
